...
% with state noise and coupling noise
% Version 2
% System Definition
% x+ = x + u * dt + n
% y  = x+  + v
...
Q = 16;                     % Process noise factor
R1 = 4; R2 = 9;             % Measurement noise factors
...
v3 = r3 * randn(1,N);       % Coupling Noise factor

v1 = r1 * randn(1,N);       % Indivisual noise factor
y1 = H*xt + v1 + v3;        % Indivisual noise factor

v2 = r2 *  randn(1,N);    
y2 = H*xt + v2 + v3;

% Trackers positional initialization
x1 = zeros(1,N);
x1(1) = xt0;
x2 = zeros(1,N);
x2(1) = xt0;
